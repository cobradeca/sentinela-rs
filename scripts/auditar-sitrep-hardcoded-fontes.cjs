...
const endpoints = [
  ...
  ["INPE BDQueimadas", `https://${PROJECT_REF}.supabase.co/functions/v1/inpe-queimadas-rs?days=2&limit=5`, (d) => d.ok === true && Array.isArray(d.records) && typeof d.count === "number", "SITREP real: focos de fogo ativo no RS"],

export const NAV_ITEMS = [
  ...
  { id: "enso", tab: "enso", label: "El Niño / La Niña", icon: "climate" },
  { id: "noticias-enso", tab: "noticias-enso", label: "Notícias", icon: "news" },
  { id: "cptec", tab: "cptec", label: "Clima Sazonal", icon: "cloud" },
...
export const PAGE_META = {
  ...
  enso: { title: "El Niño / La Niña", subtitle: "Acompanhamento do El Niño e La Niña — índice e probabilidades" },
  "noticias-enso": { title: "Notícias El Niño", subtitle: "Acompanhe o cenário climático" },
  cptec: { title: "Clima Sazonal", subtitle: "Análises e produtos oficiais de previsão do CPTEC/INPE" },

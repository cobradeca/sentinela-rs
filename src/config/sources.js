...
export const CEMADEN_RS_FUNCTION_URL = `${SUPABASE_FUNCTIONS_BASE_URL}/cemaden-rs`;
...
export const NOTIFICATION_HEALTH_FUNCTION_URL = `${SUPABASE_FUNCTIONS_BASE_URL}/notification-health`;

...
export const LAGOA_MONITORAMENTO_HISTORICO_FUNCTION_URL = `${SUPABASE_FUNCTIONS_BASE_URL}/lagoa-monitoramento-historico`;
...
export const RODOVIAS_RS_FUNCTION_URL = `${SUPABASE_FUNCTIONS_BASE_URL}/rodovias-rs`;
export const AWC_METAR_CORREDOR_FUNCTION_URL = `${SUPABASE_FUNCTIONS_BASE_URL}/awc-metar-corredor`;

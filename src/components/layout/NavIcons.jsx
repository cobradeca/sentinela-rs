  ...
  return (
    <div className="sr-logo" style={{ width: size, height: size }}>
      <svg viewBox="0 0 48 48" width={size} height={size} aria-hidden="true">
        <path d="M8 38 L24 6 L40 38 Z" fill="#009c3b" />
        <path d="M8 38 L24 22 L40 38 Z" fill="#ffdf00" />
        <path d="M24 22 L40 38 L24 38 Z" fill="#002776" />
        <circle cx="24" cy="14" r="3" fill="#fff" />
        <rect x="22.5" y="10" width="3" height="8" rx="1" fill="#fff" />
        <line x1="24" y1="6" x2="24" y2="2" stroke="#fff" strokeWidth="1.5" />
        <circle cx="24" cy="2" r="1.2" fill="#fff" />
      </svg>
    </div>
  );
}
